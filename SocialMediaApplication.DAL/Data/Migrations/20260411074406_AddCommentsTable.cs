    ...
    public partial class AddCommentsTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserLikeComment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserLikeComment_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_PostId_DateOfCreation",
                table: "Comments",
                columns: new[] { "PostId", "DateOfCreation" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLikeComment_UserId_CommentId",
                table: "UserLikeComment",
